    ...
    ListType: [
      ...
      },
      {
        ...
        li: [
          ...
          { name: "Trademarks", link: "/trademarks" },
          { name: "Accessibility", link: "/accessibility" },
          { name: "Unsolicited Idea Policy ", link: "/unsolicited-idea-policy" },
          { name: "Attributions", link: "/attributions" },
          { name: "Do Not Sell Or Share My Personal Information", link: "/" },
        ],
      },
      {
        li: [{ name: "Royal Perks", link: "/royalperks" }],
      },
      {
        li: [
          { name: "Royal Perks Terms of Service", link: "/terms-conditions-rewards" },
